          ...
          <div className="col-lg-7 col-md-10 col-12">
            <div className="row justify-content-md-start justify-content-center">
              <div className="col-12 col-md-10 col-lg-9">
                <div>
                  <h1 className="text-md-start text-center banner-text mb-3">
                  ...
                  <div className="row">
                    <div class=" col-6 col-lg-3">
                      <label
                        ...
                        class="form-label border-0 d-flex align-items-center"
                      >
                        <FaMapMarkerAlt className="fs-4 me-2" />
                        <span>Location</span>
                      </label>
                      <select
                        class="py-2 px-1 border-0 input-outline"
                    ...
                    <div class="col-6 col-lg-3">
                      ...
                      <input
                        className="input-outline py-2 border-0 rounded-3"
                        type="date"
                        name="date"
                        id=""
                      />
