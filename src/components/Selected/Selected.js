          ...
          <div className="row align-items-center">
            <div className="col-12 col-md-6 text-center text-md-start">
              ...
              <p>
                ...
                You can search by clicking our button on below of the this text
                man.
              </p>
              ...
              <div className="row mt-4 justify-content-center justify-content-md-start">
                <div className="col-12 col-md-10">
                  <div className="position-relative">
                    <input
                      className="search-input w-100 py-2 px-5 border-0"
                      type="search"
                      name="search"
              ...
              <div className="row justify-content-center justify-content-md-end">
                <div className="col-12 col-md-11">
                  <div className="text-center text-md-start">
                    ...
                    <p>
                      We make sure give you a lot of promo every motnh or event
                      based on calendar. If you want, just Subscribe on
                      Newsletter.
                    </p>
                  </div>
